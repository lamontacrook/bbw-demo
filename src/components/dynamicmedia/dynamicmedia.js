...
const DynamicMedia = ({ asset, alt = 'WKND image', title = 'Title Missing', itemProp = 'asset', imageSizes, rendition }) => {
  ...
  // https://smartimaging.scene7.com/is/image/DynamicmediaNA1/bc_wellnessrebrandnatsoul_sp2_hps?$Cart$
  console.log(imageFile);
  return (
    <picture>
      <img src={`${domain}is/image/${imageFile}?$${rendition}$`} />
